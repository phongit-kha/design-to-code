...
export function ProjectSection({
  ...
  return (
    <div className={cn("mt-16 w-full", className)}>
      ...
      <h2 className="mt-3 bg-gradient-to-r from-accent to-secondary bg-clip-text text-4xl font-extrabold text-transparent lg:text-[54px]">
        Check out my featured <br hidden className="lg:block" /> projects
      </h2>
      <div className="mt-10 grid w-full grid-cols-1 gap-8 leading-tight sm:grid-cols-2 lg:gap-12 2xl:grid-cols-4">
